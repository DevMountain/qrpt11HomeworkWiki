...
Allowing testers to work on a real time application environment 
Capabilities allows testers to use chrome capabilities with the brower instant created with builder
...
Key or Keys is just the keys on a keyboard this allows for typing in inputs or hitting common keys 
*/ 
